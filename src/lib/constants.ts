...
export const cars = {
  ...
  'F1 23': [
    { name: 'Red Bull', type: 'F1' },
    { name: 'Ferrari', type: 'F1' },
    { name: 'Mercedes', type: 'F1' },
    { name: 'Alpine', type: 'F1' },
    { name: 'McLaren', type: 'F1' },
    { name: 'Alfa Romeo', type: 'F1' },
    { name: 'Aston Martin', type: 'F1' },
    { name: 'Haas', type: 'F1' },
    { name: 'Alpha Tauri', type: 'F1' },
    { name: 'Williams', type: 'F1' },
  ],
